...
const FaceVigilance = preload("res://assets/textures/face_fear_2.png")
const FaceAdmiration = preload("res://assets/textures/admirationamybe.png")
...
static func get_symbol(type:int):
	match(type):
		...
		EmotionScale.TYPES.VIGILANCE: return FaceVigilance
